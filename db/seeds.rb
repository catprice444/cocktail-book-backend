...
alcohol_a = Alcohol.create(name: "Vodka", website: "https://vinepair.com/spirits-101/intro-vodka-guide/")
alcohol_b = Alcohol.create(name: "Tequila", website: "https://vinepair.com/spirits-101/intro-tequila-guide/")
alcohol_c = Alcohol.create(name: "Gin", website: "https://vinepair.com/spirits-101/intro-gin-guide/")
alcohol_d = Alcohol.create(name: "Rye Whiskey", website: "https://vinepair.com/spirits-101/intro-rye-whiskey-guide/")
alcohol_e = Alcohol.create(name: "Rum", website: "https://vinepair.com/spirits-101/intro-rum-guide/")

cocktail_a = Cocktail.create(name: "Gin Martini", alcohol: alcohol_c, 
...
cocktail_b = Cocktail.create(name: "Negroni", alcohol: alcohol_c, 
...
cocktail_c = Cocktail.create(name: "Moscow Mule", alcohol: alcohol_a, 
...
cocktail_d = Cocktail.create(name: "Cosmopolitan", alcohol: alcohol_a, 
...
cocktail_e = Cocktail.create(name: "Margarita", alcohol: alcohol_b, 
...
cocktail_f = Cocktail.create(name: "Tequila Sunrise", alcohol: alcohol_b, 
...
cocktail_g = Cocktail.create(name: "Rye Old Fashion", alcohol: alcohol_d, 
...
cocktail_h = Cocktail.create(name: "Sazerac", alcohol: alcohol_d, 
...
cocktail_i = Cocktail.create(name: "Mai Tai", alcohol: alcohol_e, 
...
cocktail_j = Cocktail.create(name: "Pina Colada", alcohol: alcohol_e, 
